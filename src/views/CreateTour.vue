<template>
  ...
  <div class="waper-createtour">
    <!--    1 Elemento: titulo y search bar-->
    <div class="title-bar-container">
      <div class="bar-title">
        <span>Create your own tour</span>
      </div>
      <div class="addbutton">
        <form>
    ...
    <!--    3 Elemento: contenedor-->
    <div class="big-container">
      <div class="list-container">
        <div class="icons-container">
          <div class="icon">
            <text> Places you will visit on your tour</text>
          </div>
        </div>
        <div class="item-container">
          <text class="item"> Eifel Tower </text>
          <text class="item"> Arch of Triumph </text>
...
.waper-createtour {
  ...
  .title-bar-container {
    ...
    grid-row-start: 2;
    // que cada componente quede en un cuadro
    display: flex;
    // grilla horizontal
    flex-direction: row;
    // elementos alineados
  ...
  .big-container {
    ...
    // Cada elementotiene su popio borde
    border-radius: 5px;
    // Este gran contenedor tiene 2 elementos principales
    display: grid;
    // grilla horizontal
